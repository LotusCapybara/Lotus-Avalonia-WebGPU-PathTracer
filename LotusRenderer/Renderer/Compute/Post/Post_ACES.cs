...
public unsafe class Post_ACES : IDisposable
{
    ...
    public Post_ACES(PostProcessing postPro, Scene scene, BindGroups globalBinds)
    {
        _pp = postPro;
        _scene = scene;
    ...
    private void MakePipeline()
    {
        ...
        _pipeline = GpuComputePipeline.FromEmbedded("post_aces", _pipelineLayout, "kernel_aces");
    }
